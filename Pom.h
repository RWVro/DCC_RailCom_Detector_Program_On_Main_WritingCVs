...
byte LocInstructionByte = 236;          // Instruction
byte LocCVAddressByte = 4;              // CV Address = CV Number from NMRA list minus 1
byte LocCVValueByte = 80 ;              // Write value 80
byte LocErrorByte = 182;                // Error byte
...
//================================== Send Loc Write Packet ====================

void CVPomWritePacket()
{
  sendDCCPreamble();
  dccZeroPulse();         // start bit
  sendLocAddress();
